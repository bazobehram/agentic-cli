...
export enum EventMetadataKey {
  ...
  // Logs the Surface from where the agentic-cli was invoked, eg: VSCode.
  GEMINI_CLI_SURFACE = 39,

  // Logs the session id
  GEMINI_CLI_SESSION_ID = 40,

  // Logs the agentic-cli version
  GEMINI_CLI_VERSION = 54,

  // Logs the agentic-cli Git commit hash
  GEMINI_CLI_GIT_COMMIT_HASH = 55,

  // Logs the agentic-cli OS
  GEMINI_CLI_OS = 82,
