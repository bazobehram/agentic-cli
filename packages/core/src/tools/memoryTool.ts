...
export const AGENTIC_CONFIG_DIR = '.agentic-cli';
...
export function setAgenticMdFilename(newFilename: string | string[]): void {
...
export function getCurrentAgenticMdFilename(): string {
...
export function getAllAgenticMdFilenames(): string[] {
  if (Array.isArray(currentContextFilename)) {
    return currentContextFilename;
  }
  return [currentContextFilename];
...
function getGlobalMemoryFilePath(): string {
  return path.join(Storage.getGlobalAgenticDir(), getCurrentAgenticMdFilename());
}
